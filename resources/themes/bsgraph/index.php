...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo THEMEPATH; ?>/css/dygraph.css">
        ...
        <script src="<?php echo THEMEPATH; ?>/js/dygraph.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      var fname = $("#directory-listing li[data-name$='.pedlog']").first().attr("data-href");
      if(fname)
      {
        var g = new Dygraph(
